...
<head>
  ...
  <title>DJ Prestige Sound - Analytiques</title>
...
<body>
  <!-- Sidebar commun (actif sur "Analytiques") -->
  <div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
      ...
      <a href="admin-analytics.php" class="menu-item active">
  ...
  <div class="main-content" id="mainContent">
    ...
    <div class="dashboard-section">
      <!-- Zone pour afficher des graphiques et indicateurs de performance -->
      <p>Tableaux de bord et analyses à implémenter...</p>
    </div>
  </div>
