...
<head>
  ...
  <title>DJ Prestige Sound - Logs Système</title>
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
      ...
      <a href="admin-logs.php" class="menu-item active">
  ...
  <div class="main-content" id="mainContent">
    ...
    <div class="dashboard-section">
      <!-- Zone pour afficher les journaux d'activité -->
      <p>Logs et historiques à implémenter...</p>
    </div>
  </div>
