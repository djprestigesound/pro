...
<head>
  ...
  <title>DJ Prestige Sound - Lieux & Partenaires</title>
...
<body>
  <!-- Sidebar commun (actif sur "Lieux & Partenaires") -->
  <div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
      ...
      <a href="admin-venues.php" class="menu-item active">
  ...
  <div class="main-content" id="mainContent">
    <div class="top-bar">
      <h1 class="page-title">Lieux & Partenaires</h1>
    </div>
    <div class="dashboard-section">
      <!-- Zone pour gérer les lieux et partenariats -->
      <p>Contenu de la gestion des lieux et partenaires à implémenter...</p>
    </div>
  </div>
