...
<head>
  ...
  <title>DJ Prestige Sound - Marketing</title>
...
<body>
  <!-- Sidebar commun (actif sur "Marketing") -->
  <div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
      ...
      <a href="admin-marketing.php" class="menu-item active">
  ...
  <div class="main-content" id="mainContent">
    ...
    <div class="dashboard-section">
      <!-- Zone de gestion des campagnes, emails, réseaux sociaux, etc. -->
      <p>Contenu de la section Marketing à implémenter...</p>
    </div>
  </div>
