...
<head>
  ...
  <title>DJ Prestige Sound - Gestion des Prestataires</title>
...
<body>
  <!-- Sidebar commun (actif sur "Prestataires") -->
  <div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
      ...
      <a href="admin-providers.php" class="menu-item active">
  ...
  <div class="main-content" id="mainContent">
    ...
    <div class="dashboard-section">
      <!-- Zone pour la gestion des prestataires -->
      <p>Liste et détails des prestataires à implémenter...</p>
    </div>
  </div>
