...
<head>
  ...
  <title>DJ Prestige Sound - Gestion du Personnel</title>
...
<body>
  <!-- Sidebar commun (identique, active sur "Personnel") -->
  <div class="sidebar" id="sidebar">
    <!-- … même code de sidebar qu'au dessus, avec ce lien actif : -->
    ...
    <div class="sidebar-menu">
      ...
      <a href="admin-staff.php" class="menu-item active">
  ...
  <div class="main-content" id="mainContent">
    ...
    <div class="dashboard-section">
      <!-- Zone pour afficher et gérer les membres de l'équipe -->
      <p>Liste et détails du personnel à implémenter...</p>
    </div>
  </div>
