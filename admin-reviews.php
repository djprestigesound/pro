...
<head>
  ...
  <title>DJ Prestige Sound - Avis Clients</title>
...
<body>
  <!-- Sidebar commun (actif sur "Avis clients") -->
  ...
  <div class="main-content" id="mainContent">
    ...
    <div class="dashboard-section">
      <!-- Zone pour afficher et modérer les avis clients -->
      <p>Liste des avis clients à implémenter...</p>
    </div>
  </div>
