...
<head>
  ...
  <title>DJ Prestige Sound - Planification</title>
...
<body>
  <!-- Sidebar commun (actif sur "Planification") -->
  <div class="sidebar" id="sidebar">
    <!-- … code de sidebar similaire avec le lien Planification actif -->
    ...
    <div class="sidebar-menu">
      ...
      <a href="admin-scheduling.php" class="menu-item active">
  ...
  <div class="main-content" id="mainContent">
    ...
    <div class="dashboard-section">
      <!-- Zone pour gérer les plannings et rendez-vous -->
      <p>Contenu de la planification à implémenter...</p>
    </div>
  </div>
