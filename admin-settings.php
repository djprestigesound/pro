...
<head>
  ...
  <title>DJ Prestige Sound - Paramètres</title>
...
<body>
  <!-- Sidebar commun (actif sur "Paramètres") -->
  ...
  <div class="main-content" id="mainContent">
    ...
    <div class="dashboard-section">
      <!-- Zone de configuration générale du site -->
      <p>Options de configuration à implémenter...</p>
    </div>
  </div>
